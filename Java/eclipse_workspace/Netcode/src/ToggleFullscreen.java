...
public class ToggleFullscreen extends JFrame {
	 ...
	 * 
	 * @param gd
	 *            A valid GraphicsDevice to be used for this application.
	 */
	 ...
	 * ToggleFullscreen object by passing the default GraphicsDevice to the
	 * constructor.
	 * 
	 * @param args
	 *            Command line parameters (could be used to toggle fullscreen at
	 *            start up.)
	 */
	public static void main(String[] args) {

		// Get the default graphics configuration from the graphics environment
		new ToggleFullscreen(GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice());
