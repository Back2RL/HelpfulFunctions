...
public class Orbit {
	...
	public static void main(String[] args) {
		...
		Planet earth = new Planet(5.972E24, false, 6371.0E3);
		Planet moon = new Planet(7.34767309E22, false, 1737.0E3);
		...
		double orbitVelEarth = moon.getOrbitVelocity(moon, distance);
		double orbitVelMoon = moon.getOrbitVelocity(earth, distance);
