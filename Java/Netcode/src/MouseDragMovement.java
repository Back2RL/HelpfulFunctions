 ...
 * This snippet can be used to make mouse based movement games. <br/>
 ...
 * Challenge: There were issues when the block gets to close to the mouse in
 * some circumstances I attempted to fix it by checking to see if the mouse was
 * over the block, but this didn't work 100% of the time. See if you can figure
 * out a way to get it to never move back and forth around the cursor not matter
 * what situation.
 * 
 * @author Nick
 */
