...
SOURCES += CPUtime.cpp
SOURCES += main.cpp
SOURCES += Loops/ForEach.cpp
SOURCES += Loops/Hand.cpp
SOURCES += Loops/HandOpt.cpp
SOURCES += Loops/HandOptRef.cpp
SOURCES += Loops/Iterator.cpp
SOURCES += Loops/IteratorOpt.cpp
